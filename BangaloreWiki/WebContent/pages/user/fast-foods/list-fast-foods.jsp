...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    ...
    $(function() {
        ...
        $("#format").buttonset();
        $("#records-section").load("../bwiki/fast-foods/display");

        $("#format input").click(function(){
        	$("#records-section").load("../bwiki/fast-foods/"+$(this).attr("id"));
        });
    });
    </script>
    
	<div id="theatres-form">
	<p class="records-header">Fast Food Centres in Bangalore.</p>
